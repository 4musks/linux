...
s64 count_each_exit_reason[70];
EXPORT_SYMBOL(count_each_exit_reason);

u64 total_proc_cycles = 0;
EXPORT_SYMBOL(total_proc_cycles);

u64 count_eachexit_proc_cycles[70];
	...
	if (eax == 0x4ffffffc) {
		 ...
		 */
			...
			edx = 0;
				...
				printk(KERN_INFO "0x4ffffffe, Exit number %u. Total exits=%lld\n", 
